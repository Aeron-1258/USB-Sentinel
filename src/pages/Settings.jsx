          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
              ...
              <div style={{ display: "grid", gap: "24px", maxWidth: "600px" }}>
                ...
                >
                  <div>
                    ...
                    >
                      What happens when a device without a recognized hardware ID is inserted.
                    </div>
                  </div>
                  <select
                ...
                >
                  <div>
                    ...
                    >
                      Automatically isolate hosts if BadUSB signatures are detected.
                    </div>
                  </div>
                  <Toggle
                    checked={usbSettings.autoQuarantine}
                    onChange={(e) =>
                      setUsbSettings({ ...usbSettings, autoQuarantine: e.target.checked })
                    }
                  />
                </div>
                ...
                >
                  <div>
                    ...
                    >
                      Deny all devices implicitly unless explicitly added to the global allowlist.
                    </div>
                  </div>
                  <Toggle
                    checked={usbSettings.strictMode}
                    onChange={(e) =>
                      setUsbSettings({ ...usbSettings, strictMode: e.target.checked })
                    }
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <p style={{ fontSize: "13px", color: "var(--color-text-secondary)" }}>
                Manage organizational unit (OU) exceptions in the Policy Management tab.
              </p>
              ...
              <div style={{ display: "grid", gap: "24px", maxWidth: "600px" }}>
                ...
                >
                  <div>
                    ...
                    >
                      Send critical alerts to SOC distribution list.
                    </div>
                  </div>
                  <Toggle
                    checked={notifySettings.email}
                    onChange={(e) =>
                      setNotifySettings({ ...notifySettings, email: e.target.checked })
                    }
                  />
                </div>
                ...
                >
                  <div>
                    ...
                    >
                      Send text messages to on-call administrators for high-severity incidents.
                    </div>
                  </div>
                  <Toggle
                    checked={notifySettings.sms}
                    onChange={(e) =>
                      setNotifySettings({ ...notifySettings, sms: e.target.checked })
                    }
                  />
                </div>
                ...
                >
                  <div>
                    ...
                    >
                      Pipe audit logs and alerts into #soc-alerts channel.
                    </div>
                  </div>
                  <Toggle
                    checked={notifySettings.slack}
                    onChange={(e) =>
                      setNotifySettings({ ...notifySettings, slack: e.target.checked })
                    }
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div style={{ display: "grid", gap: "24px", maxWidth: "600px" }}>
                ...
                >
                  <div>
                    <div style={{ fontWeight: 600, fontSize: "14px" }}>
                      Google Material Design 3 Light Mode
                    </div>
                    <div
                      style={{
                        fontSize: "13px",
                    ...
                    >
                      Clean enterprise Light Mode styling active across all dashboard views.
                    </div>
                  </div>
              ...
              <div style={{ display: "grid", gap: "24px", maxWidth: "600px" }}>
                ...
                >
                  <div>
                    ...
                    >
                      Require all analysts to use MFA when accessing this dashboard.
                    </div>
                  </div>
                  <Toggle
                    checked={secSettings.mfa}
                    onChange={(e) => setSecSettings({ ...secSettings, mfa: e.target.checked })}
                  />
                </div>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setSecSettings({ ...secSettings, sessionTimeout: e.target.value })
                    }
                    style={{
                      width: "80px",
                      padding: "8px",
      ...
      default:
        return (
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            <h2
              className="heading-2"
              style={{ borderBottom: "1px solid var(--color-border-light)", paddingBottom: "12px" }}
            >
              {activeCategory} Settings
            </h2>
            <p style={{ color: "var(--color-text-tertiary)", fontSize: "14px" }}>
              Configuration options for {activeCategory} are available in the enterprise edition.
            </p>
          </div>
        );
    }
