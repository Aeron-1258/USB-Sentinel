        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <h1 className="heading-1" style={{ margin: 0 }}>
              Data Loss Prevention (DLP) Console
            </h1>
            <div
              style={{
                display: "flex",
          ...
          <p className="text-subtitle">
            Forensic file transfer monitoring, VirusTotal verification, and SHA-256 hash logging
          </p>
        </div>
      </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", display: "flex", flexDirection: "column" }}>
          {events.length === 0 && (
            ...
            >
              ...
              >
                No active DLP file transfers logged yet.
              </div>
              <div style={{ fontSize: "13px", marginTop: "4px" }}>
                Copy or modify a file on any connected USB drive to generate live forensic logs.
              </div>
            </div>
          )}
          {events.map((evt) => (
            ...
            >
              ...
              <div
                style={{ width: "220px", display: "flex", alignItems: "flex-start", gap: "8px" }}
              >
                <span
                  className="material-symbols-rounded"
                  style={{ color: "var(--color-blue-500)", fontSize: "20px" }}
                >
                  description
                </span>
              ...
              <div style={{ width: "130px", color: "var(--color-text-primary)" }}>{evt.user}</div>
              ...
              <div style={{ width: "160px" }}>
                <span
                  ...
                  style={{ fontSize: "10px", display: "inline-block", marginBottom: "2px" }}
                >
                  Defender: Clean
                </span>
