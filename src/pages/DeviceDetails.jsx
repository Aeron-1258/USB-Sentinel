...
export default function DeviceDetails({ deviceId, onBack }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <div>
            ...
            <p className="text-subtitle" style={{ fontFamily: "monospace" }}>
              Fingerprint: {device.fingerprintId} | VID: {device.vid} PID: {device.pid}
            </p>
          </div>
        </div>
      ...
      <div
        className="card"
        style={{ padding: "4px 8px", display: "flex", gap: "4px", flexShrink: 0 }}
      >
        {[
      ...
      >
              ...
              <table style={{ width: "100%", fontSize: "13px", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    ...
                    <td style={{ padding: "8px 0" }}>{device.manufacturer}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Product Name
                    </td>
                    <td style={{ padding: "8px 0" }}>{device.productName}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Vendor ID (VID)
                    </td>
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>{device.vid}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Product ID (PID)
                    </td>
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>{device.pid}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Serial Number
                    </td>
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>{device.serial}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Device Class
                    </td>
                    <td style={{ padding: "8px 0" }}>{device.deviceClass}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table style={{ width: "100%", fontSize: "13px", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    ...
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>{device.pnpId}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Device GUID
                    </td>
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>{device.guid}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      USB Revision
                    </td>
                    <td style={{ padding: "8px 0" }}>{device.usbRevision}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Instance Path
        ...
        {activeTab === "driver" && (
          <div className="card">
            <h3 style={{ margin: "0 0 16px 0", fontSize: "14px", fontWeight: 600 }}>
              Windows Driver & Integrity Certification
            </h3>
            <div
              style={{
                display: "grid",
            ...
            >
              <div>
                <div
                  style={{ padding: "8px 0", borderBottom: "1px solid var(--color-border-light)" }}
                >
                  <span style={{ color: "var(--color-text-secondary)" }}>Driver Version:</span>{" "}
                  <strong style={{ fontFamily: "monospace" }}>{device.driver.version}</strong>
                </div>
                <div
                  style={{ padding: "8px 0", borderBottom: "1px solid var(--color-border-light)" }}
                >
                  <span style={{ color: "var(--color-text-secondary)" }}>Driver Provider:</span>{" "}
                  <strong>{device.driver.provider}</strong>
                </div>
                <div style={{ padding: "8px 0" }}>
                  <span style={{ color: "var(--color-text-secondary)" }}>Driver Release Date:</span>{" "}
                  <span>{device.driver.date}</span>
                </div>
              </div>
              <div>
                <div
                ...
                >
                  ...
                  <span className="badge badge-success">{device.driver.signature}</span>
                </div>
                <div
                  style={{ padding: "8px 0", borderBottom: "1px solid var(--color-border-light)" }}
                >
                  <span style={{ color: "var(--color-text-secondary)" }}>Certificate Status:</span>{" "}
                  <span className="badge badge-success">{device.driver.certificate}</span>
                </div>
                <div style={{ padding: "8px 0" }}>
                  <span style={{ color: "var(--color-text-secondary)" }}>
                    Kernel HVCI Integrity:
                  </span>{" "}
                  <span className="badge badge-success">{device.driver.integrity}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === "connection" && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-3)" }}>
            <div className="card">
              <h3 style={{ margin: "0 0 16px 0", fontSize: "14px", fontWeight: 600 }}>
                Physical Connection Topography
              </h3>
              <table style={{ width: "100%", fontSize: "13px", borderCollapse: "collapse" }}>
                <tbody>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    ...
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>
                      Port #{device.connection.portNumber} | Bus {device.connection.busNumber} | Hub{" "}
                      {device.connection.hubNumber}
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                  ...
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    ...
                    <td style={{ padding: "8px 0", fontFamily: "monospace" }}>
                      {device.connection.physicalPath}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                    ...
                    <td style={{ padding: "8px 0", fontWeight: 600 }}>{device.connection.speed}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table style={{ width: "100%", fontSize: "13px", borderCollapse: "collapse" }}>
                <tbody>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    ...
                    <td style={{ padding: "8px 0", fontFamily: "monospace", fontWeight: 600 }}>
                      {device.connection.mountPoint} ({device.connection.driveLetter})
                    </td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                    ...
                    <td style={{ padding: "8px 0" }}>{device.connection.filesystem}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Capacity
                    </td>
                    <td style={{ padding: "8px 0" }}>{device.connection.capacity}</td>
                  </tr>
                  <tr style={{ borderBottom: "1px solid var(--color-border-light)" }}>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                      Space Allocation
                    ...
                    <td style={{ padding: "8px 0" }}>
                      Used: {device.connection.usedSpace} | Free: {device.connection.freeSpace}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ padding: "8px 0", color: "var(--color-text-secondary)" }}>
                    ...
                    <td style={{ padding: "8px 0" }}>{device.connection.volumeLabel}</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        {activeTab === "history" && (
          <div className="card">
            <h3 style={{ margin: "0 0 16px 0", fontSize: "14px", fontWeight: 600 }}>
              Connection History & Lifecycle Metrics
            </h3>
            <div
              style={{
                display: "grid",
            ...
            >
              <div>
                <span style={{ color: "var(--color-text-tertiary)" }}>First Seen:</span>
                <div style={{ fontWeight: 600, marginTop: "2px" }}>{device.history.firstSeen}</div>
              </div>
              <div>
                <span style={{ color: "var(--color-text-tertiary)" }}>Last Connected:</span>
                <div style={{ fontWeight: 600, marginTop: "2px" }}>
                  {device.history.lastConnected}
                </div>
              </div>
              <div>
                <span style={{ color: "var(--color-text-tertiary)" }}>Total Connections:</span>
                <div style={{ fontWeight: 600, marginTop: "2px" }}>
                  {device.history.totalConnections} Times
                </div>
              </div>
              <div>
                <span style={{ color: "var(--color-text-tertiary)" }}>Cumulative Usage:</span>
                <div style={{ fontWeight: 600, marginTop: "2px" }}>
                  {device.history.totalUsageTime}
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === "security" && (
          ...
          >
            <div className="card">
              <h4 style={{ margin: "0 0 12px 0", color: "var(--color-text-secondary)" }}>
                Trust Score
              </h4>
              <div style={{ fontSize: "36px", fontWeight: 700, color: "var(--color-green-600)" }}>
                {device.security.trustScore}/100
              </div>
            ...
            <div className="card">
              ...
              <div style={{ fontSize: "16px", fontWeight: 600, color: "var(--color-green-600)" }}>
                {device.security.policyDecision}
              </div>
              <div
                style={{ fontSize: "12px", color: "var(--color-text-tertiary)", marginTop: "4px" }}
              >
                {device.security.policyApplied}
              </div>
            </div>
          </div>
        )}
          ...
          <div className="card">
            ...
            >
              ...
              <div>
                ...
                >
                  {device.threatIntel.mitreMapping.map((m, i) => (
                    <li key={i}>{m}</li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <div style={{ display: "flex", gap: "8px", marginTop: "4px" }}>
                  {device.threatIntel.cveReferences.map((cve, i) => (
