  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
        ...
        <div
          className={`badge ${device.status === "Authorized" ? "badge-success" : device.status === "Blocked" ? "badge-danger" : "badge-warning"}`}
        >
          {device.status}
        </div>
      </div>
      ...
      <div
        style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", fontSize: "12px" }}
      >
        <div>
