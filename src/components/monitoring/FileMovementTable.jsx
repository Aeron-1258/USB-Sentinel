...
export default function FileMovementTable({ files }) {
  const getFileIcon = (filename) => {
    ...
    switch (ext) {
      case "pdf":
        return { icon: "picture_as_pdf", color: "var(--color-red-500)" };
      case "doc":
      case "docx":
        return { icon: "description", color: "var(--color-blue-500)" };
      case "xls":
      case "xlsx":
      case "csv":
        return { icon: "table_chart", color: "var(--color-green-500)" };
      case "zip":
      case "tar":
        return { icon: "folder_zip", color: "var(--color-orange-500)" };
      case "jpg":
      case "png":
        return { icon: "image", color: "var(--color-blue-600)" };
      default:
        return { icon: "draft", color: "var(--color-gray-500)" };
    }
  };
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        title={`${file.source} -> ${file.destination}`}
                      >
                        {file.source}{" "}
