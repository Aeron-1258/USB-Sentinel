  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-brand">
        <span className="material-symbols-rounded icon-filled" style={{ color: 'var(--color-blue-500)', fontSize: 28 }}>
          admin_panel_settings
        </span>
        <span className="brand-title" style={{ fontSize: 'var(--font-size-lg)'}}>USB Control</span>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.label}
              {item.id === 'alerts' && <span style={{ marginLeft: 'auto', backgroundColor: 'var(--color-red-500)', color: 'white', borderRadius: '12px', padding: '2px 6px', fontSize: '11px', fontWeight: 'bold' }}>3</span>}
            </a>
          );
        })}
      </nav>
