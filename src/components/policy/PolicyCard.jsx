    ...
    >
      ...
      <div
        style={{
          ...
          backgroundColor: selected ? "var(--color-surface)" : "var(--color-surface-hover)",
          display: "flex",
          alignItems: "center",
      ...
      >
        <span
          ...
          style={{ fontSize: "28px", color: "var(--color-text-secondary)" }}
        >
      ...
      >
        ...
        <span style={{ fontSize: "13px", fontWeight: 600, color: getRiskColor(device.risk) }}>
          {device.risk}
        </span>
      </div>
      ...
      <div style={{ display: "flex", gap: "8px" }}>
        ...
        <button className="btn-icon" title="Approve / Move" onClick={() => onApprove(device.id)}>
          <span
            ...
            style={{ fontSize: "20px", color: "var(--color-green-600)" }}
          >
            check_circle
          </span>
        </button>
        <button className="btn-icon" title="Delete" onClick={() => onDelete(device.id)}>
          <span
            className="material-symbols-rounded"
            style={{ fontSize: "20px", color: "var(--color-red-600)" }}
          >
            delete
          </span>
        </button>
