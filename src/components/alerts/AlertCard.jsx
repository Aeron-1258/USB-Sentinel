    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span
            ...
            style={{ color: getSeverityColor(alert.severity), fontSize: "24px" }}
          >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span
            className={`badge ${alert.status === "Resolved" ? "badge-success" : alert.status === "Unread" ? "badge-danger" : "badge-neutral"}`}
          >
            {alert.status}
          </span>
        </div>
      ...
      >
        ...
        <div>
          ...
          <span
            style={{ fontSize: "13px", fontWeight: 600, color: getSeverityColor(alert.severity) }}
          >
      ...
      <div style={{ display: "flex", gap: "12px", marginTop: "4px" }}>
        ...
        <button
          ...
          onClick={() => onAction(alert.id, "Mark Resolved")}
          style={{ color: "var(--color-green-600)", borderColor: "var(--color-green-200)" }}
        >
