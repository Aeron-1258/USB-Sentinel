  ...
  const events = [
    {
      id: 1,
      type: "critical",
      title: "Unauthorized Mass Storage Detected",
      time: "10:42 AM",
      desc: "SanDisk Ultra 64GB blocked on WIN-DESK-04.",
    },
    {
      id: 2,
      type: "info",
      ...
      time: "09:00 AM",
      desc: "Global USB read-only policy v2.4 applied to Engineering group.",
    },
    {
      id: 3,
      type: "warning",
      ...
      time: "Yesterday",
      desc: "Unrecognized YubiKey attempted 5 logins on SRV-09.",
    },
    {
      id: 4,
      type: "success",
      ...
      time: "Yesterday",
      desc: "No compliance violations found in Executive group.",
    },
  ];
