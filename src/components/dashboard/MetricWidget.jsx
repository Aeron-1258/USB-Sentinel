...
export default function MetricWidget({ title, value, unit, trend, type = 'default' }) {
  ...
  return (
    <div className="card" style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '4px' }}>
      <span style={{ fontSize: '12px', fontWeight: 500, color: 'var(--color-text-secondary)', textTransform: 'uppercase', letterSpacing: '0.02em' }}>
        {title}
      </span>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
        ...
        {trend !== undefined && (
          <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', color: getTrendColor(), fontSize: '12px', fontWeight: 500 }}>
